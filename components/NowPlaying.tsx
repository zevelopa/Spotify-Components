...
function AnimatedBars() {
  ...
  return (
        ...
        <span
            id="bar1"
            className="w-1 mr-[3px] h-2 bg-gray-400 dark:bg-gray-300 opacity-75"
        />
        <span
            id="bar2"
            className="w-1 mr-[3px] h-1 bg-gray-600 dark:bg-gray-200"
        />
        <span
            id="bar3"
            className="w-1 h-3 bg-gray-500 dark:bg-gray-400 opacity-80"
        />
        </div>
    );
}
...
export default function NowPlaying() {
    ...
    return (
        <div className="flex flex-row-reverse items-center sm:flex-row mb-8 space-x-0 sm:space-x-2 w-full gap-4">
        {data?.songUrl ? (
            <AnimatedBars />
        ) : (
